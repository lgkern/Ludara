...
bool CModelAl::Init(int obj)
{
  ...
  m_poObject = new C3DObject();
	...
	switch(obj){
		case 1:
			printf(":D\n");
			if (!m_poObject->Load("../res/1/CREATURE/DRAGONSINESTRA/dragon.obj")) {
		...
		case 2:
			printf(":)\n");
			if (!m_poObject->Load("../res/2/CREATURE/DRAGONSINESTRA/dragon.obj")) {
			  printf("Problem loading model!");
			  return false;
		  }
			break;
		case 3:
			if (!m_poObject->Load("../res/3/CREATURE/DRAGONSINESTRA/dragon.obj")) {
				  printf("Problem loading model!");
				  return false;
			  }
			break;
		case 4:
			if (!m_poObject->Load("../res/4/CREATURE/DRAGONSINESTRA/dragon.obj")) {
				  printf("Problem loading model!");
				  return false;
			  }
			break;
		case 5:
			if (!m_poObject->Load("../res/5/CREATURE/DRAGONSINESTRA/dragon.obj")) {
				  printf("Problem loading model!");
				  return false;
			  }
			break;
		case 6:
			if (!m_poObject->Load("../res/6/CREATURE/DRAGONSINESTRA/dragon.obj")) {
				  printf("Problem loading model!");
				  return false;
			  }
			break;
		case 7:
			if (!m_poObject->Load("../res/7/CREATURE/DRAGONSINESTRA/dragon.obj")) {
				  printf("Problem loading model!");
				  return false;
			  }
			break;
